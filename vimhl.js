...
(function() {
  var cheerio, crypto, execSync, formatFilter, fs, temp, vimHighlight, wrench;
  ...
  vimHighlight = function(data, ft, useLineN) {
    var $, _storageTemplateFolder, cacheFileFd, cacheFileHash, cacheFileName, htmlPath, info, lineOpt, opt, result, ret;
